...
const ScoreCardPopup = ({  onClose, matchId, matchType, teamId, matchOpponent, date }) => {
  ...
  <div className="flex pb-2 tracking-wider flex-wrap justify-start items-center gap-3">
    ...
    <select
      className="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-md block px-3 py-1 mt-1 focus:outline-none focus:ring-1 focus:ring-[#2c2e34]" defaultValue=" Select Inning"
      id="inning"
      value={inningNumber}
      onChange={handleInningChange}
    >
      {/* <option value={0}  className="text-sm text-gray-700 px-3" >
        Select Inning
      </option> */}
  ...
  onInput={(e) => {
    ...
    // Don't auto-correct if user is still typing (e.g., "1.")
    ...
    handleEditInputChange(e); // Update form state
  }}
  placeholder="O"
...
/>
  ...
  onInput={(e) => {
    ...
    handleAddInputChange(e); // Update form state
  }}
  placeholder="O"
  className="border rounded p-1 bg-blue-50 w-16"
/>
